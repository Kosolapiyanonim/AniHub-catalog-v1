// Создайте новый файл: /app/api/parse-latest/route.ts
...
// Этот эндпоинт всегда запрашивает первую страницу самых последних обновлений
export async function POST(request: Request) {
  ...
  try {
    ...
    for (const anime of animeList) {
      ...
      await supabase.from('translations').upsert(translationRecord, { onConflict: 'kodik_id' });
    ...
    return NextResponse.json({
      message: `Последние обновления обработаны. Найдено и сохранено: ${processedCount} записей.`,
