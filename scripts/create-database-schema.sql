...
-- Только аутентифицированные могут писать собственные (idempotent)
DO $$
BEGIN
...
-- Пользователь может обновлять/удалять только свои комментарии (idempotent)
DO $$
BEGIN
