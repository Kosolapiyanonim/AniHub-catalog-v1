...
// --- [ИЗМЕНЕНИЕ] Добавляем raw_data для HeroSlider ---
const HERO_ANIME_SELECT = `id, shikimori_id, title, poster_url, year, description, shikimori_rating, raw_data, episodes_count, status, genres:anime_genres(genres(name))`;
