...
const formatStatus = (status: string | null) => { /* ... код из предыдущих шагов ... */ };
const formatType = (type: string | null) => { /* ... код из предыдущих шагов ... */ };
const formatDate = (dateString: string | null) => { /* ... код из предыдущих шагов ... */ };
